...
SENSOR_TYPES: tuple[CowboySensorEntityDescription, ...] = (
    ...
    # CowboySensorEntityDescription(
    #     key="bike_total_distance",
    #     translation_key="bike_total_distance",
    #     native_unit_of_measurement="km",
    #     icon="mdi:map-marker-distance",
    #     data_type="bike_total_distance",
    #     value_fn=lambda bike: bike.bike_total_distance or 0,
    # ),
    # CowboySensorEntityDescription(
    #     key="bike_total_duration",
    #     translation_key="bike_total_duration",
    #     native_unit_of_measurement="s",
    #     suggested_unit_of_measurement="auto",
    #     icon="mdi:clock-outline",
    #     data_type="bike_total_duration",
    #     value_fn=lambda bike: bike.bike_total_duration or 0,
    # ),
    # CowboySensorEntityDescription(
    #     key="bike_total_co2_saved",
    #     translation_key="bike_total_co2_saved",
    #     native_unit_of_measurement="g",
    #     suggested_unit_of_measurement="kg",
    #     icon="mdi:cloud-check",
    #     data_type="bike_total_co2_saved",
    #     value_fn=lambda bike: bike.bike_total_co2_saved or 0,
    # ),
    # CowboySensorEntityDescription(
    #     key="bike_state_of_charge",
    #     translation_key="bike_state_of_charge",
    #     native_unit_of_measurement="%",
    #     icon="mdi:battery",
    #     data_type="bike_state_of_charge",
    #     value_fn=lambda bike: bike.bike_state_of_charge or 0,
    # ),
    # CowboySensorEntityDescription(
    #     key="bike_state_of_charge_internal",
    #     translation_key="bike_state_of_charge_internal",
    #     native_unit_of_measurement="%",
    #     icon="mdi:battery",
    #     data_type="bike_state_of_charge_internal",
    #     value_fn=lambda bike: bike.bike_state_of_charge_internal or 0,
    # ),
)
